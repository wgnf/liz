...
public class GetPackageReferencesViaPackagesConfigTests
{
    ...
    public async Task GetFromProject_Logs_Warning_When_Packages_Config_Not_Found()
    {
        ...
        var projectFileInfo = mockFileSystem.FileInfo.New(projectFile);
    ...
    public async Task GetFromProject()
    {
        ...
        var packageReferences = new[] { new PackageReference("Something", "netSomething", "something"), new PackageReference("Autofac", "net472", "1.2.3") };
