...
public class DeserializeProjectExclusionGlobsPreprocessorTests
{
    [Fact]
    public async Task Does_Nothing_When_Setting_Not_Set()
    {
        var settings = Mock.Of<ExtractLicensesSettingsBase>();
        settings.ProjectExclusionGlobsFilePath = null;

        var context = ArrangeContext<DeserializeProjectExclusionGlobsPreprocessor>.Create();
    ...
    {
        var settings = Mock.Of<ExtractLicensesSettingsBase>();
        settings.ProjectExclusionGlobsFilePath = "something";
...
[
  ...
  ""something""
        ...
        settings.ProjectExclusionGlobs.Add(alreadyExistingEntry);
        settings.ProjectExclusionGlobsFilePath = "something";
